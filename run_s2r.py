...
parser.add_argument('--train_seq_len', type=int, default=9)
parser.add_argument('--test_seq_len', type=int, default=9)
parser.add_argument('--dim_feedforward', type=int, default=8)
parser.add_argument('--test_only', type=bool, default=False)
parser.add_argument('--ckpt_load_path', type=str, default='./wandb/offline-run-20241126_173732-5ov3wlt4/files/checkpoints/ResInf_epoch167.pt')
...
if __name__ == '__main__':
    ...
    os.environ["WANDB_API_KEY"] = 'aebcb53f9bea046da13d53b6bb3f73995a3060da'
